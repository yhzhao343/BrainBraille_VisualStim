...
export function prepBrainBrailleStim(
  ...
  const curr_text = document.createElementNS(
  ...
  const next_text = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "text",
  );
  ...
  const curr_word = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "text",
  );
  ...
  const curr_index = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "text",
  );
  ...
  const curr_bb_body_g = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "g",
  );
  ...
  const curr_dot_elements = curr_dot_ids.map((id) =>
    document.getElementById(id),
  );

  // Create the right next body svg
  const next_bb_body_g = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "g",
  );
  ...
  const next_dot_elements = next_dot_ids.map((id) =>
    document.getElementById(id),
  );
